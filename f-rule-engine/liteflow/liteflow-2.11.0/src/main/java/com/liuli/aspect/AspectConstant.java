...
public enum AspectConstant {
     ...
     * @since 1.0.0
     */
    AspectConstant(String constant) {
    ...
    public static Map<String,String> getConstantMap(){
        ...
        for (AspectConstant aspectConstant : AspectConstant.values()) {
            map.put(aspectConstant.name(),aspectConstant.getConstant());
        }
        return map;
    }
}
